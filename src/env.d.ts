...
declare module "virtual:panel-registry" {
  import type { ComposedRegistry } from "@tracht-digital-solutions/tds-panel-contract";
  export const registry: ComposedRegistry;
}

declare module "virtual:panel-widgets" {
  import type { WidgetManifest } from "@tracht-digital-solutions/tds-panel-contract";
...
declare module "virtual:panel-settings" {
  import type { SettingsPanel } from "@tracht-digital-solutions/tds-panel-contract";
